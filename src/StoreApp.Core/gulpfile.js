...
gulp.task("watch", function () {
    ...
    var log = function (event) {
        if (event.type === "deleted") {
            runSequence("clean");
            setTimeout(function () {
                runSequence("copy:html", "copy:sass", "copy:images", "copy:lib", "copy:others", /*"browserify",*/ "watch");
            }, 1000);
        }
...
gulp.task("default", ["clean", "copy:html", "copy:sass", "copy:images", "copy:js", "copy:lib", "copy:others", "copy:media", "copy:data", /*"browserify",*/ "browserSync", "watch"]);
gulp.task("build", ["clean", "copy:html", "copy:sass", "copy:images", "copy:js", "copy:lib", "copy:others", "copy:media", "copy:data"/*"browserify"*/]);
